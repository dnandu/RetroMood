...
//        /// <summary>
//        /// Constructor used to build the ML model
//        /// </summary>
//        /// <param name="testdata">has the path to the dataset used to evaluate the model</param>
//        /// <param name="data">has the path to the dataset used to train the model.</param>
//        public static void StartTraining(string testdata, string data)
//        {
//            Train();
//            Evaluate();
//        }
...
//        public static string Predict(string content)
//        {
